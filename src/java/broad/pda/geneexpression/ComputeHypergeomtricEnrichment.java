...
public class ComputeHypergeomtricEnrichment {
	...
	public ComputeHypergeomtricEnrichment(MatrixWithHeaders diffExpressed, Map<String, Collection<String>> geneSets, Map<String, String> chipInfo, String save, double alpha, int cutoff) throws MathException, IOException{
		this.alpha=alpha;
	...
	private void enrichment(Collection<String> up, Collection<String> down, Map<String, Collection<String>> geneSets, Map<String, String> chipInfo, MatrixWithHeaders geneSetMatrix, String experiment, List<String> genes) throws MathException {
	...
	private Map<String, Double> computeEnrichment(Map<String, Collection<String>> geneSets, int universe, Collection<String> up, Collection<String> down) throws MathException{
	...
	public ComputeHypergeomtricEnrichment(Collection<String> set1, Collection<String> set2, Collection<String> universe) throws MathException{
	...
	public static void main(String[] args)throws IOException, MathException, ParseException{
		if(args.length>5){

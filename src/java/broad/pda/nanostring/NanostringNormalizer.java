...
public class NanostringNormalizer {
	...
	public NanostringNormalizer(File file, String save) throws IOException, ParseException{
	...
	public static void main(String[] args)throws IOException, ParseException{
		if(args.length>1){
			...
			String save=args[1];
			new NanostringNormalizer(file, save);
		}

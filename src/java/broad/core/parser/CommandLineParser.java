...
public final class CommandLineParser {
	...
	public void parse(String[] args) {
		...
		while(i < args.length) {
			...
			if(args.length == i+1) {
				System.err.println("\n------------------------------------------------------");
				System.err.println("Invalid command line: a flag can't be the last item");
				System.err.println("------------------------------------------------------\n");
				printHelpMessage();
				System.exit(-1);
			}
			...
			if(!this.hasFlag(args[i]) ) {
				System.err.println("\n------------------------------------------------------");
				System.err.println("Invalid command line: flag doesn't exist: " + args[i]);
				System.err.println("------------------------------------------------------\n");
				printHelpMessage();
				System.exit(-1);
			}
			...
			if(this.commandLineValues.containsKey(args[i])) {
				System.err.println("\n------------------------------------------------------");
				System.err.println("Invalid command line: flag is specified twice: " + args[i]);
				System.err.println("------------------------------------------------------\n");
				printHelpMessage();
				System.exit(-1);
			}
			...
			if(this.hasFlag(args[i+1])) {
				System.err.println("\n------------------------------------------------------");
				System.err.println("Invalid command line: next item shouldn't be a flag: " + args[i+1]);
				System.err.println("------------------------------------------------------\n");
				printHelpMessage();
				System.exit(-1);
			}

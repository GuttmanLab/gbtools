...
public class EmpiricalDistribution {
	...
	UnknownDistributionChiSquareTest chi = new ChiSquareTestImpl();
     ...
     */
    public double testGoodnessOfFit(EmpiricalDistribution other) throws IllegalArgumentException, MathException {
     ...
     * @throws MathException
     */
    public double chiSquareDistance(EmpiricalDistribution other) throws IllegalArgumentException, MathException, IOException {
    	if(other.intervalDataNumber.length != intervalDataNumber.length) {
    		throw new IllegalArgumentException("Distributions have different number of bins: " +intervalDataNumber.length +" vs " +other.intervalDataNumber.length);
    	}
    	double sum = 0.0;
     ...
     * @throws MathException
     */
    public double KLDivergence(EmpiricalDistribution other) throws IllegalArgumentException, MathException,IOException {
    	/*
    ...
    public double KLDivergenceSym(EmpiricalDistribution other) throws IllegalArgumentException, MathException, IOException {
	...
	protected long[] getIntervalDataNumber() {

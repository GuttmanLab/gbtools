...
public class ComputePercentageOfKmers {
	...
	public ComputePercentageOfKmers(File BEDScores, Collection<RefSeqGene> genes, String save, double alpha)throws IOException{
		Map<Alignments, List<OmegaFit>> omega=parseScores(BEDScores);
		Map<RefSeqGene, Double> percentageMap=getPercentageOfKmers(omega, genes, alpha);
		write(save, percentageMap);
	}
	...
	private Map<RefSeqGene, Double> getPercentageOfKmers(Map<Alignments, List<OmegaFit>> map, Collection<RefSeqGene> genes, double alpha){

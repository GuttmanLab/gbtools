...
public class qPCRPrimerDesigner  {
	...
	public static Set<PrimerPair> designJenPrimers(Chromosome chr, RefSeqGene gene, boolean repeatMask, int numDesigns)throws Exception{
	...
	*/
	...
	public static Collection<PrimerPair> designIntronPrimers(Chromosome chr, RefSeqGene gene, boolean repeatMask, String sequencePrimer, String sequencePrimerRevComp, int numDesigns, int min3, int min5) throws Exception {
		Primer3Configuration best = Primer3ConfigurationFactory.getJenRTPCRConfiguration();
	...
	public static Collection<PrimerPair> designPCRPrimers(Chromosome chr, RefSeqGene gene, boolean repeatMask,	int numDesigns, boolean crossJunction) throws Exception {
		Primer3Configuration best = Primer3ConfigurationFactory.getJenRTPCRConfiguration();
	...
	public static Collection<PrimerPair> designPCRPrimers(Chromosome chr, RefSeqGene gene, boolean repeatMask,	int numDesigns,  SequenceRegionCoordinates target) throws Exception {
		Primer3Configuration best = Primer3ConfigurationFactory.getJenRTPCRConfiguration();
	...
	public static void main(String[] args) throws IOException {
		...
		if(regions == null) seqs.addAll(inputseqs);
